...
query2.connectionParameters = process.env.DB_CONNECT;
...
module.exports.editOffer = function(offer, cb){
	var values = [offer.offerId, offer.offerName, offer.type, offer.price, offer.description, offer.startDate, offer.endDate, offer.offerImageName, offer.timeFrom, offer.timeTo, offer.weekdays];

	var q = 'UPDATE "Offers" SET name = $2, type = $3, price = $4, description = $5, "startDate" = $6, "endDate" = $7, photo = $8, "timeFrom" = $9, "timeTo" = $10, weekdays = $11 WHERE id = $1';
