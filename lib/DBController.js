...
module.exports.getValuesFromTableByAtt = function getValuesFromTableByAtt(sessionValues, cb){
	//.....eða values
	var values = req.Session;

	var q = 'SELECT ($3) FROM ($1) WHERE "name" = ($2) AND "type" = ($4) AND "price" BETWEEN ($5) AND ($6)';
...
module.exports.getOffers = function(q, values, cb){
